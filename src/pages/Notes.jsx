            ...
            <div className="w-80 bg-bg-card border border-border/50 rounded-3xl p-4 flex flex-col shadow-sm">
                ...
                <div className="flex-1 overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                    {filteredNotes.length === 0 ? (
                        <div className="text-center text-text-muted/50 mt-10 italic text-sm">No notes found</div>
                    ) : (
                        filteredNotes.map((note) => (
                            ...
                            >
                                <h3 className="font-semibold truncate text-text-main mb-1">{note.title || 'Untitled'}</h3>
            ...
            <div className="flex-1 bg-bg-card border border-border/50 rounded-3xl p-8 flex flex-col shadow-sm overflow-hidden">
                {activeNote ? (
                        ...
                        <div className="flex items-start justify-between mb-8 border-b border-border/50 pb-6">
                            ...
                            <div className="flex items-center gap-2 shrink-0 bg-bg-main p-1.5 rounded-full border border-border/50">
                                ...
                                <button
                                    ...
                                    className="p-3 text-text-muted hover:text-red-500 hover:bg-red-500/10 rounded-full transition-colors tooltip tooltip-right"
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-text-muted opacity-60">
                        ...
                        <h3 className="text-2xl font-bold mb-2">No Note Selected</h3>
